...
#define UE_MODULE_NAME "HttpGPTEditorModule"
...
#define HTTPGPTCOMMONMODULE_API DLLIMPORT
#define HTTPGPTCHATMODULE_API DLLIMPORT
#define HTTPGPTIMAGEMODULE_API DLLIMPORT
#define HTTPGPTEDITORMODULE_API DLLEXPORT
